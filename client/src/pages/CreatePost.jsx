    ...
    <section className='max-w-7xl mx-auto' >
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px] ' >
          Create imaginative and visually stunning images through by DALL-E AI and shered with them the community
        </p>
      </div>
        ...
        <div>
          ...
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
            ...
            {form.photo ? (
              ...
              <img src={preview} alt="prview" className='w-9/12 h-9/12 object-contain opacity-40' />
            )}
